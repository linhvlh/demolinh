...
(lib.Symbol17 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(144,437,0.24,0.24);
	...
	this.shape.setTransform(161.875,449.8);
	...
	this.instance_1.setTransform(0,0,0.3299,1.92);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,320,483.7);
...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	// Layer_1 copy
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(41.0474,12.9762,0.95,0.95);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(41.0474,12.9762,0.95,0.95);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	// Layer_2
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#2A7EBE").s().p("ArtCYIAAkvIXbAAIAAEvg");
	this.shape_2.setTransform(40.5,12.4);
...
(lib.Symbol10 = function(mode,startPosition,loop) {
	...
	mask.setTransform(103.575,-64.075);

	// Layer_1
	this.instance = new lib.text();
	this.instance.parent = this;
	this.instance.setTransform(22,-70,0.41,0.41);
...
p.nominalBounds = new cjs.Rectangle(22,-70,168.5,22.700000000000003);
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AxGCcIAAk4MAiNAAAIAAE4g");
	mask.setTransform(89.85,52.3);

	// Layer_1
	this.instance = new lib.text();
	this.instance.parent = this;
	this.instance.setTransform(-4,3,0.41,0.41);
...
p.nominalBounds = new cjs.Rectangle(-4,36.7,168.5,24.099999999999994);
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	mask.setTransform(-13.025,-3.925);

	// Layer_1
	this.instance = new lib.text();
	this.instance.parent = this;
	this.instance.setTransform(-98,-35,0.44,0.44);
...
p.nominalBounds = new cjs.Rectangle(-98,-9.7,180.9,11.6);
...
p.nominalBounds = new cjs.Rectangle(-27.2,105.8,336.2,58.60000000000001);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(168.4,345.6,0.72,0.72,0,0,0,43.6,7.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(168.45,345.7,0.72,0.72,0,0,0,43.7,7.9);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(166.55,107.4,0.89,0.89,0,0,0,104,7.2);
	...
	this.instance_3.setTransform(166.6,191.2,1,1,0,0,0,334.6,86.2);
	...
	this.instance_4.setTransform(87.8,183.8,1,1,0,0,0,62.8,63.8);
...
p.nominalBounds = new cjs.Rectangle(-253.1,0,832.2,483.7);
...
p.nominalBounds = new cjs.Rectangle(160,240,160,243.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1693378837348", id:"bg"},
		{src:"images/light.png?1693378837348", id:"light"},
		{src:"images/logo.png?1693378837348", id:"logo"},
		{src:"images/tagline.png?1693378837348", id:"tagline"},
		{src:"images/text.png?1693378837348", id:"text"}
	],
	preloads: []
};
