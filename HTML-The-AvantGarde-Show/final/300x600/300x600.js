...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(98,519,0.84,0.84);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(152.5,432.7,1,1,0,0,0,43.5,7.7);
	...
	this.instance_3.setTransform(149.8,150,1,1,0,0,0,103.8,7);
	...
	this.instance_4.setTransform(155.6,242.2,1,1,0,0,0,334.6,86.2);
	...
	this.instance_5.setTransform(62.6,239.1,1,1,0,0,0,62.6,63.6);
...
p.nominalBounds = new cjs.Rectangle(-266.3,0,834.4000000000001,606.4);
...
p.nominalBounds = new cjs.Rectangle(150,300,150,306.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1693228995427", id:"bg"},
		{src:"images/light.png?1693228995427", id:"light"},
		{src:"images/logo.jpg?1693228995427", id:"logo"},
		{src:"images/tagline.png?1693228995427", id:"tagline"},
		{src:"images/text.png?1693228995427", id:"text"}
	],
	preloads: []
};
