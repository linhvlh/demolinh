...
p.nominalBounds = new cjs.Rectangle(-141,-32,971,250);
...
(lib.Symbol10 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(10,-37,0.245,0.245);
...
p.nominalBounds = new cjs.Rectangle(10,-37,100.7,12.5);
...
p.nominalBounds = new cjs.Rectangle(-188.5,-43.7,1068.1,275);
...
p.nominalBounds = new cjs.Rectangle(-39.2,136.1,382.59999999999997,15.400000000000006);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(825,192,0.59,0.59);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(488,202.25,0.94,0.94,0,0,0,43.6,7.7);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(488,202.35,0.94,0.94,0,0,0,43.6,7.8);
	...
	this.instance_3.setTransform(487.05,38.25,1.3,1.3,0,0,0,103.9,7.1);
	...
	this.instance_4.setTransform(475.6,118.2,1,1,0,0,0,334.6,86.2);
	...
	this.instance_5.setTransform(371.65,55.7,1.3,1.3,0,0,0,62.8,63.6);
...
p.nominalBounds = new cjs.Rectangle(-47.5,-11.7,1068.1,275);
...
p.nominalBounds = new cjs.Rectangle(485,121.5,485,131.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1693230550217", id:"bg"},
		{src:"images/light.png?1693230550217", id:"light"},
		{src:"images/logo.jpg?1693230550217", id:"logo"},
		{src:"images/tagline.png?1693230550217", id:"tagline"},
		{src:"images/text.png?1693230550217", id:"text"}
	],
	preloads: []
};
