...
p.nominalBounds = new cjs.Rectangle(-33.4,-8.6,736.1,189.79999999999998);
...
(lib.Symbol11copy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0},0).to({scaleX:0.9,scaleY:0.9},3,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},3,cjs.Ease.get(1)).to({scaleX:0.9,scaleY:0.9},3,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},3,cjs.Ease.get(1)).wait(29));
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:156.4,alpha:1},8,cjs.Ease.quadOut).wait(169).to({startPosition:0},0).to({_off:true},1).wait(4116));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({alpha:1},6,cjs.Ease.get(1)).wait(165).to({startPosition:0},0).to({_off:true},1).wait(4116));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:128,alpha:1},8,cjs.Ease.quadOut).wait(169).to({startPosition:0},0).to({_off:true},1).wait(4116));
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(68).to({_off:false},0).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(41).to({_off:false},0).to({_off:true},27).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(7).to({_off:false},0).wait(190));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(19).to({_off:false},0).wait(178));

	// Layer_8
	this.instance_6 = new lib.bg();
	this.instance_6.parent = this;
	this.instance_6.setTransform(0,0,0.8571,0.8572);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(197));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-212.4,0,736.1,252.7);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1693130304633", id:"bg"},
		{src:"images/logo.jpg?1693130304633", id:"logo"},
		{src:"images/tagline.png?1693130304633", id:"tagline"},
		{src:"images/text.png?1693130304633", id:"text"}
	],
	preloads: []
};
