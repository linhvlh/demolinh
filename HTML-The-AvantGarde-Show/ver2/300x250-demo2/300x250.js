...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(-1,0,0.69,0.69);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1,0,670.3,172.5);
...
(lib.Symbol11copy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.1,scaleY:1.1},10,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},10,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-348.6,-35.3,1365.4,91);
...
p.nominalBounds = new cjs.Rectangle(-336.6,-86.3,1340.5,345);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(70).to({_off:false},0).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(43).to({_off:false},0).to({_off:true},27).wait(129));
...
p.nominalBounds = new cjs.Rectangle(-515.6,-54.3,1340.5,345);
