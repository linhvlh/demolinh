...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgLALQgEgFAAgGQAAgGAEgFQAGgEAGAAQAGAAAFAEQAEAFAAAGQAAAGgEAFQgFAFgGAAQgHAAgFgFg");
	this.shape.setTransform(193.1,17.025);
...
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,56.099999999999994,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-17.7,392,41.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Background1.jpg?1695285629197", id:"Background1"},
		{src:"images/Background2.jpg?1695285629197", id:"Background2"},
		{src:"images/EQE.png?1695285629197", id:"EQE"},
		{src:"images/logo.png?1695285629197", id:"logo"}
	],
	preloads: []
};
