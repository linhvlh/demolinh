...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(193.2721,16.3747);
...
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,56,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-8.7,391.9,32.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1695285900806", id:"bg1"},
		{src:"images/bg2.jpg?1695285900806", id:"bg2"},
		{src:"images/EQE.png?1695285900806", id:"EQE"},
		{src:"images/logo.png?1695285900806", id:"logo"}
	],
	preloads: []
};
