...
p.nominalBounds = new cjs.Rectangle(0,0,420,825);
...
(lib.Symbol15 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:300}).wait(95).to({graphics:mask_graphics_95,x:150,y:300}).wait(1).to({graphics:null,x:0,y:0}).wait(2919));
...
(lib.Symbol13 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-10,-9,0.26,0.26);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1208));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10,-9,52,52);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:150,y:300}).wait(168).to({graphics:mask_graphics_168,x:150,y:300}).wait(1).to({graphics:null,x:0,y:0}).wait(4131));

	// Layer_1
	this.instance = new lib.bg1();
	this.instance.parent = this;
	this.instance.setTransform(-3,-1,0.73,0.73);
...
p.nominalBounds = new cjs.Rectangle(-3,-1,306.6,602.2);
...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(166.25,9.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,55.400000000000006,28.1);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Ap3CWIAAkrITvAAIAAErg");
	mask.setTransform(40.55,13.575);
...
p.nominalBounds = new cjs.Rectangle(-22.7,-1.4,126.5,30);
...
p.nominalBounds = new cjs.Rectangle(16,-8.7,391.3,32.5);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(148.5,284.5,1,1,0,0,0,15.5,15.5);
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(149.5,667.5,1,1,0,0,0,15.5,15.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({_off:false},0).wait(108).to({startPosition:108},0).to({x:-146.5,startPosition:124},16,cjs.Ease.get(1)).wait(96));

	// logo
	this.instance_2 = new lib.Symbol13("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(150.5,545.5,1,1,0,0,0,15.5,15.5);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(150.85,203.35,1,1,0,0,0,42.4,10.1);
	...
	this.instance_4.setTransform(151.25,206.7,1.5,1.5,0,0,0,43.5,7.8);
	...
	this.instance_5.setTransform(148.45,144.8,1.28,1.3199,0,0,0,103.5,8.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(118).to({startPosition:65},0).to({x:-150,startPosition:73},16,cjs.Ease.get(1)).wait(96));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-300,0,900,625);
...
p.nominalBounds = new cjs.Rectangle(147,299,156.60000000000002,302.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1695285827541", id:"bg1"},
		{src:"images/bg2.jpg?1695285827541", id:"bg2"},
		{src:"images/EQE.png?1695285827541", id:"EQE"},
		{src:"images/logo.png?1695285827541", id:"logo"}
	],
	preloads: []
};
