...
(lib.Symbol13 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(192).to({_off:true},1).wait(1015));
...
(lib.Symbol13copy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:43.7,regY:6,scaleX:0.95,scaleY:0.95,x:14.75,y:-171.95,alpha:1},10,cjs.Ease.get(1)).to({regX:43.8,regY:6.1,scaleX:1,scaleY:1,x:14.8,y:-171.9},8,cjs.Ease.get(1)).wait(164).to({startPosition:0},0).to({_off:true},1).wait(998));
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:7.6,scaleX:1.1,scaleY:1.1,x:43.4,y:7.6,alpha:1},11,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},10,cjs.Ease.get(1)).wait(114).to({startPosition:0},0).to({_off:true},1).wait(1829));
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({_off:false},0).to({x:100.25,alpha:1},9,cjs.Ease.get(1)).to({x:103.1},9,cjs.Ease.get(1)).wait(144).to({startPosition:0},0).to({_off:true},1).wait(1303));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).to({x:100.25,alpha:1},9,cjs.Ease.get(1)).to({x:103.1},9,cjs.Ease.get(1)).wait(146).to({startPosition:0},0).to({_off:true},1).wait(1298).to({_off:false},0).to({_off:true},1).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},0).to({x:100.25,alpha:1},9,cjs.Ease.get(1)).to({x:103.1},9,cjs.Ease.get(1)).wait(148).to({startPosition:0},0).to({_off:true},1).wait(1298).to({_off:false},0).to({_off:true},3).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:100.25,alpha:1},9,cjs.Ease.get(1)).to({x:103.1},9,cjs.Ease.get(1)).wait(150).to({startPosition:0},0).to({_off:true},1).wait(1298).to({_off:false},0).wait(5));
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(157.5,206.5,1,1,0,0,0,15.5,15.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,970.1,250);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1695218804181", id:"bg1"},
		{src:"images/bg2.jpg?1695218804181", id:"bg2"},
		{src:"images/EQE.png?1695218804181", id:"EQE"},
		{src:"images/logo.png?1695218804181", id:"logo"}
	],
	preloads: []
};
