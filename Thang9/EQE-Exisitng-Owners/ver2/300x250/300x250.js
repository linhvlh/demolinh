...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(164.825,9.625);
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(316.4,-1.2,1,1,0,0,0,103.1,7.8);
	this.instance.alpha = 0;
	...
	this.instance_1.setTransform(316.4,-1.2,1,1,0,0,0,103.1,7.8);
	...
	this.instance_2.setTransform(316.4,-1.2,1,1,0,0,0,103.1,7.8);
	...
	this.instance_3.setTransform(316.4,-1.2,1,1,0,0,0,103.1,7.8);
...
p.nominalBounds = new cjs.Rectangle(16,-17.7,388.4,41.5);
...
p.nominalBounds = new cjs.Rectangle(-300,0,900,265.9);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Background1.jpg?1695273967820", id:"Background1"},
		{src:"images/Background2.jpg?1695273967820", id:"Background2"},
		{src:"images/EQE.png?1695273967820", id:"EQE"},
		{src:"images/logo.png?1695273967820", id:"logo"}
	],
	preloads: []
};
