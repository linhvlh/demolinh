...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(165.225,9.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,53.30000000000001,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-8.7,389.2,32.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1695274135656", id:"bg1"},
		{src:"images/bg2.jpg?1695274135656", id:"bg2"},
		{src:"images/EQE.png?1695274135656", id:"EQE"},
		{src:"images/logo.png?1695274135656", id:"logo"}
	],
	preloads: []
};
