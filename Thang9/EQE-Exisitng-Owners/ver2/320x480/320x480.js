...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(165.075,9.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,53,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-8.7,388.9,32.5);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(160.5,433.5,1,1,0,0,0,15.5,15.5);
...
p.nominalBounds = new cjs.Rectangle(-320,0,960,501.8);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1695274293831", id:"bg1"},
		{src:"images/bg2.jpg?1695274293831", id:"bg2"},
		{src:"images/EQE.png?1695274293831", id:"EQE"},
		{src:"images/logo.png?1695274293831", id:"logo"}
	],
	preloads: []
};
