...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(165,9.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,52.900000000000006,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-8.7,388.8,32.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1695274479957", id:"bg1"},
		{src:"images/bg2.jpg?1695274479957", id:"bg2"},
		{src:"images/EQE.png?1695274479957", id:"EQE"},
		{src:"images/logo.png?1695274479957", id:"logo"}
	],
	preloads: []
};
