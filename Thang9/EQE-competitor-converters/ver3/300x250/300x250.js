...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(166,9.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,54.900000000000006,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-11.3,390.8,35.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/b1.jpg?1695286318823", id:"b1"},
		{src:"images/b2.jpg?1695286318823", id:"b2"},
		{src:"images/b3.jpg?1695286318823", id:"b3"},
		{src:"images/EQE.png?1695286318823", id:"EQE"},
		{src:"images/logo.png?1695286318823", id:"logo"}
	],
	preloads: []
};
