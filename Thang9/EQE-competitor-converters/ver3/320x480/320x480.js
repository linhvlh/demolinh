...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgJAMQgDgFAAgHQAAgGADgEQAFgFAEAAQAGAAAEAFQADAEAAAGQAAAHgDAFQgEAEgGAAQgEAAgFgEg");
	this.shape.setTransform(193.55,16.725);
...
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,56.30000000000001,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-11.3,392.2,35.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/b1.jpg?1695286562799", id:"b1"},
		{src:"images/b2.jpg?1695286562799", id:"b2"},
		{src:"images/b3.jpg?1695286562799", id:"b3"},
		{src:"images/EQE.png?1695286562799", id:"EQE"},
		{src:"images/logo.png?1695286562799", id:"logo"}
	],
	preloads: []
};
