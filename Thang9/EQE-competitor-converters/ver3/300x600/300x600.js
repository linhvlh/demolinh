...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgHALQgEgEAAgHQAAgFAEgEQADgEAFgBQAEABAEAEQADAEAAAFQAAAGgDAFQgEADgEAAQgFAAgDgDg");
	this.shape.setTransform(192.8935,16.6241,1.1,1.1);
...
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,55.599999999999994,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-11.3,391.5,35.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/b1.jpg?1695286422385", id:"b1"},
		{src:"images/b2.jpg?1695286422386", id:"b2"},
		{src:"images/b3.jpg?1695286422386", id:"b3"},
		{src:"images/EQE.png?1695286422386", id:"EQE"},
		{src:"images/logo.png?1695286422386", id:"logo"}
	],
	preloads: []
};
