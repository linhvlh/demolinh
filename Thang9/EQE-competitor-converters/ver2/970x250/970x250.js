...
(lib.Symbol17copy3 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(164.675,9.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.6,-4.4,52.20000000000002,28.1);
...
p.nominalBounds = new cjs.Rectangle(16,-11.3,388.1,35.1);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(485.5,235.5,1,1,0,0,0,15.5,15.5);
	this.instance._off = true;
	...
	this.instance_4.setTransform(484.55,91.95,1.14,1.1699,0,0,0,104,8.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/b1.jpg?1695273250756", id:"b1"},
		{src:"images/b2.jpg?1695273250756", id:"b2"},
		{src:"images/EQE.png?1695273250756", id:"EQE"},
		{src:"images/logo.png?1695273250756", id:"logo"}
	],
	preloads: []
};
