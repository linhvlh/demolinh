...
p.nominalBounds = new cjs.Rectangle(-82.1,0,862.1,250);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(97).to({_off:false},0).wait(143));
...
p.nominalBounds = new cjs.Rectangle(485,121.5,507.29999999999995,131.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1692764356060", id:"bg1"},
		{src:"images/bg2.jpg?1692764356060", id:"bg2"},
		{src:"images/logo.jpg?1692764356060", id:"logo"}
	],
	preloads: []
};
