...
(lib.Symbol27 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({regX:165.1,regY:23.2,scaleX:1.1,scaleY:1.1,y:58.15,alpha:1},7,cjs.Ease.get(1)).to({regX:165.2,regY:23.1,scaleX:1,scaleY:1,x:97.2,y:58.1},7,cjs.Ease.get(1)).wait(722));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:17.3,scaleX:1.1,scaleY:1.1,alpha:1},7,cjs.Ease.get(1)).to({scaleX:1,scaleY:1},7,cjs.Ease.get(1)).wait(726));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-84.4,-1.7,363.29999999999995,85.2);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(264.5,74.3,1,1,0,0,0,130.5,17.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(205));

	// Layer_15
	this.instance_6 = new lib._300x600_flasprite3_24();
	this.instance_6.parent = this;
	this.instance_6.setTransform(222.25,92,0.59,0.59,-177.0008,0,0,-0.4,0);
	this.instance_6.alpha = 0.8008;
	this.instance_6.shadow = new cjs.Shadow("rgba(253,124,43,1)",0,0,14);
	this.instance_6.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},45).wait(160));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1733813767725", id:"bg"},
		{src:"images/hoa.png?1733813767725", id:"hoa"},
		{src:"images/phao01.png?1733813767725", id:"phao01"},
		{src:"images/phao02.png?1733813767725", id:"phao02"},
		{src:"images/phao03.png?1733813767725", id:"phao03"},
		{src:"images/phao04.png?1733813767725", id:"phao04"},
		{src:"images/sp1.png?1733813767725", id:"sp1"},
		{src:"images/sp2.png?1733813767725", id:"sp2"},
		{src:"images/sp3.png?1733813767725", id:"sp3"},
		{src:"images/t1.png?1733813767725", id:"t1"},
		{src:"images/t2.png?1733813767725", id:"t2"},
		{src:"images/talent.png?1733813767725", id:"talent"}
	],
	preloads: []
};
