...
(lib.Symbol13 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(5,22,0.085,0.085);
	...
	this.shape.setTransform(13.325,31.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1208));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-6.9,14,40.5,35.3);
...
(lib.Symbol6copy = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(121.625,30);

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#EEBA64","#FEFDCE"],[0,0.667],-124.8,0.2,124.8,0.2).s().p("AzfFUIAAqnMAm/AAAIAAKng");
	this.shape.setTransform(147.747,52.5481,0.8086,0.5264);
...
p.nominalBounds = new cjs.Rectangle(50.8,-23,192.5,83);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AjxA9IAAh5IHkAAIAAB5g");
	mask.setTransform(49.35,2.2);

	// Layer_3
	this.instance = new lib.Symbol2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(9.8,1.5,0.6,0.7756,0,0,0,24.1,34.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:24.2,regY:34.4,scaleY:0.7078,x:88.5,y:1.7},23,cjs.Ease.get(1)).wait(67));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-3.9,73.6,12.200000000000001);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(165.25,86.65,0.275,0.275,0,0,0,168.2,46);
	this.instance._off = true;
...
p.nominalBounds = new cjs.Rectangle(7.3,16.1,345.09999999999997,88.9);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(152.5,220.5,1,1,0,0,0,15.5,15.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(136,214.2,2,2,0,0,0,42.5,10.1);
	...
	this.instance_2.setTransform(154.3,198.4,1.07,1.07,0,0,0,44.2,8.8);
	...
	this.instance_3.setTransform(98.5,-6.2,1,1,0,0,0,96.5,11.8);
	...
	this.instance_4.setTransform(148.25,13.25,0.86,0.86,0,0,0,84,37.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(58).to({regY:37.6,y:13.35,startPosition:68},0).to({alpha:0,startPosition:79},11,cjs.Ease.get(1)).wait(138));

	// Layer_8
	this.instance_5 = new lib.Symbol1("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-107.6,140.15,0.21,0.21,0,0,0,149.6,300.8);
...
p.nominalBounds = new cjs.Rectangle(-218.1,0,673.3,600);
...
p.nominalBounds = new cjs.Rectangle(150,125,150,129.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1707276630795", id:"bg"},
		{src:"images/logo.png?1707276630795", id:"logo"},
		{src:"images/xe.png?1707276630795", id:"xe"}
	],
	preloads: []
};
