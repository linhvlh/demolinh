...
(lib.Symbol13 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(1,3,0.15,0.15);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1208));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(1,3,30,30);
...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FEFEFE").s().p("");
	this.shape.setTransform(40.9,8.525);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(1,1,1).p("AmzhmINnAAIAADNItnAAg");
	this.shape_1.setTransform(41.775,7.975);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2.8,-3.3,89.2,22.6);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AmwBnIAAjNINhAAIAADNg");
	mask.setTransform(42.025,10.25);

	// Layer_2
	this.instance = new lib.Tween3("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-17.7,11.15,0.7562,1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,scaleX:1,x:104.2,y:11.55},23,cjs.Ease.get(1)).wait(67));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.2,0,86.5,20.5);
...
(lib.Symbol13copy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:6,scaleX:0.95,scaleY:0.95,x:14.8,y:-171.35,alpha:1},10,cjs.Ease.get(1)).to({regX:43.8,regY:6.1,scaleX:1,scaleY:1,y:-171.9},8,cjs.Ease.get(1)).wait(41).to({startPosition:0},0).to({regX:43.5,regY:5.8,scaleX:0.68,scaleY:0.68,x:-6.35,y:-183.5},14,cjs.Ease.get(1)).wait(1112));
...
p.nominalBounds = new cjs.Rectangle(-7.4,-4.3,98,24.6);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(149.85,245.85,1.08,1.08,0,0,0,15.6,15.6);
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(150.5,218.5,1,1,0,0,0,15.5,15.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(151.45,85.85,1,1,0,0,0,42.4,10.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(152.9,85.6,1,1,0,0,0,43.4,7.6);
	this.instance_3._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(70).to({startPosition:65},0).to({x:-150,startPosition:73},14,cjs.Ease.get(1)).wait(147));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1693643676940", id:"bg1"},
		{src:"images/bg2.jpg?1693643676940", id:"bg2"},
		{src:"images/l1.png?1693643676940", id:"l1"},
		{src:"images/logo.png?1693643676940", id:"logo"}
	],
	preloads: []
};
