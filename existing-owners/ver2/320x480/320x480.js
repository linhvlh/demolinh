...
(lib.Symbol13 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-11,-1,0.23,0.23);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1208));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-11,-1,46,46);
...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FEFEFE").s().p("");
	this.shape.setTransform(39.675,7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(1,1,1).p("Ap4iUITxAAIAAEpIzxAAg");
	this.shape_1.setTransform(39.225,6);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-25,-9.9,128.5,31.799999999999997);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("ApzCVIAAkoITnAAIAAEog");
	mask.setTransform(39.1,8.35);

	// Layer_2
	this.instance = new lib.Tween3("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-55.55,9.7,1.6299,1.7677,0,0,0,-0.2,0.1);

	this.instance_1 = new lib.Tween4("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(141,11.55,1.7719,1.6606,0,0,0,0.1,0);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,regX:0.1,regY:0,scaleX:1.7719,scaleY:1.6606,x:141,y:11.55},23,cjs.Ease.get(1)).wait(67));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-23.6,-6.5,125.5,29.7);
...
(lib.Symbol13copy = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:6,scaleX:0.95,scaleY:0.95,x:14.8,y:-171.35,alpha:1},10,cjs.Ease.get(1)).to({regX:43.8,regY:6.1,scaleX:1,scaleY:1,y:-171.9},8,cjs.Ease.get(1)).wait(41).to({startPosition:0},0).to({regX:43.5,regY:5.8,scaleX:0.68,scaleY:0.68,x:-14.65,y:-229.75},14,cjs.Ease.get(1)).wait(1112));
...
p.nominalBounds = new cjs.Rectangle(-31.8,-11.5,141.20000000000002,34.8);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(157.85,317.85,1.08,1.08,0,0,0,15.6,15.6);
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(163.5,426.5,1,1,0,0,0,15.5,15.5);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(159.45,181.85,1,1,0,0,0,42.4,10.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(160.4,181.6,1,1,0,0,0,43.4,7.6);
	this.instance_3._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(248.2,94.1,1,1,0,0,0,103.2,8.1);
	this.instance_4._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(70).to({startPosition:65},0).to({x:-170,startPosition:73},14,cjs.Ease.get(1)).wait(147));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1693645655064", id:"bg1"},
		{src:"images/bg2.jpg?1693645655064", id:"bg2"},
		{src:"images/l1.png?1693645655064", id:"l1"},
		{src:"images/logo.png?1693645655064", id:"logo"}
	],
	preloads: []
};
