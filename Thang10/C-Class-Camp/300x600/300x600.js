...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:170.65,alpha:1},11,cjs.Ease.get(1)).to({x:169.45},9,cjs.Ease.get(1)).wait(95).to({startPosition:0},0).to({x:181.45,alpha:0},16,cjs.Ease.get(1)).wait(564));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:52.9,alpha:1},11,cjs.Ease.get(1)).to({x:51.9},9,cjs.Ease.get(1)).wait(675));
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(112,458.8,1,1,0,0,0,96.5,11.8);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).wait(111).to({startPosition:111},0).to({x:124,alpha:0,startPosition:127},16,cjs.Ease.get(1)).wait(99));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1698393281310", id:"bg1"},
		{src:"images/bg2.jpg?1698393281310", id:"bg2"},
		{src:"images/logomec.png?1698393281310", id:"logomec"},
		{src:"images/logo.png?1698393281310", id:"logo"}
	],
	preloads: []
};
