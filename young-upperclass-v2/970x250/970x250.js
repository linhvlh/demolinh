...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(79).to({_off:false},0).to({x:156.4,alpha:1},13,cjs.Ease.quadOut).wait(123).to({startPosition:0},0).to({_off:true},1).wait(4081));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(79).to({_off:false},0).to({x:128,alpha:1},13,cjs.Ease.quadOut).wait(123).to({startPosition:0},0).to({_off:true},1).wait(4081));
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(89).to({_off:false},0).wait(127));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(65).to({_off:false},0).wait(151));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1692764573618", id:"bg1"},
		{src:"images/bg2.jpg?1692764573618", id:"bg2"},
		{src:"images/logo.jpg?1692764573618", id:"logo"}
	],
	preloads: []
};
