...
(lib.Symbol17 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(78.725,10.225);
...
p.nominalBounds = new cjs.Rectangle(0,0,157.5,20.5);
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(11.55,7.675);
...
p.nominalBounds = new cjs.Rectangle(-0.8,-0.2,24.7,15.799999999999999);
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(109.825,12.35);
...
p.nominalBounds = new cjs.Rectangle(4.9,1.3,209.9,22.099999999999998);
...
(lib.Symbol16copy = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(58.9,16.05);
...
p.nominalBounds = new cjs.Rectangle(1.2,5.9,115.39999999999999,20.4);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(50.5,66.55,1,1,0,0,0,78.7,10.2);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).to({x:83.75,alpha:1},11,cjs.Ease.get(1)).to({x:83},9,cjs.Ease.get(1)).wait(195).to({startPosition:0},0).to({_off:true},1).wait(686));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(5).to({_off:false},0).to({x:104.5,alpha:1},11,cjs.Ease.get(1)).to({x:103.8},9,cjs.Ease.get(1)).wait(200).to({startPosition:0},0).to({_off:true},1).wait(686));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:97.25,alpha:1},11,cjs.Ease.get(1)).to({x:96.5},9,cjs.Ease.get(1)).wait(205).to({startPosition:0},0).to({_off:true},1).wait(686));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-30.1,1.3,245.6,75.5);
...
p.nominalBounds = new cjs.Rectangle(-30.8,2.3,214.5,17.099999999999998);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1699450098342", id:"bg1"},
		{src:"images/bg2.jpg?1699450098342", id:"bg2"},
		{src:"images/logomec.png?1699450098342", id:"logomec"},
		{src:"images/logo.png?1699450098342", id:"logo"}
	],
	preloads: []
};
