...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(11.9,7.45);
...
p.nominalBounds = new cjs.Rectangle(-0.5,-0.8,24.9,16.5);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-6,-23,0.32,0.32);
...
p.nominalBounds = new cjs.Rectangle(-6,-23,320,624.5);
...
(lib.Symbol16copy = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(134.8,15.4);
...
p.nominalBounds = new cjs.Rectangle(2.2,4.6,265.3,21.6);
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(111.275,12.3);
...
p.nominalBounds = new cjs.Rectangle(6.4,1.3,209.79999999999998,22.099999999999998);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(5).to({_off:false},0).to({x:104.5,alpha:1},11,cjs.Ease.get(1)).to({x:103.8},9,cjs.Ease.get(1)).wait(200).to({startPosition:0},0).to({_off:true},1).wait(686));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:97.25,alpha:1},11,cjs.Ease.get(1)).to({x:96.5},9,cjs.Ease.get(1)).wait(205).to({startPosition:0},0).to({_off:true},1).wait(686));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-28.6,1.3,299.70000000000005,49.1);
...
(lib.Symbol1copy = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(151.2,37.8,1.3,1.2,0,0,0,151.2,68.7);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:68.8,scaleX:1,scaleY:1,y:67.8,alpha:1},17,cjs.Ease.get(1)).wait(94).to({startPosition:0},0).to({_off:true},1).wait(115).to({_off:false},0).wait(4073));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-68.7,-53,421.2,654.5);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(84.4,503.1,1,1,0,0,0,42.4,10.1);
	...
	this.instance_2.setTransform(84.6,505.05,1,1,0,0,0,43.5,7.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).wait(111).to({x:112,startPosition:111},0).to({x:124,alpha:0,startPosition:127},16,cjs.Ease.get(1)).wait(99));
...
p.nominalBounds = new cjs.Rectangle(135.7,277,178.3,324.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1699449780551", id:"bg1"},
		{src:"images/bg2.jpg?1699449780551", id:"bg2"},
		{src:"images/logomec.png?1699449780551", id:"logomec"},
		{src:"images/logo.png?1699449780551", id:"logo"}
	],
	preloads: []
};
