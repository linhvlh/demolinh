...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(152.675,22.7);
...
p.nominalBounds = new cjs.Rectangle(4,8.3,297.4,28.8);
...
(lib.Symbol16copy = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(73.9,33);
...
p.nominalBounds = new cjs.Rectangle(0.5,20.2,146.8,25.7);
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("ArHCiIAAlDIWPAAIAAFDg");
	mask.setTransform(48.925,8.575);
...
p.nominalBounds = new cjs.Rectangle(-22.2,-7.6,142.29999999999998,32.4);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:97.75,alpha:1},11,cjs.Ease.get(1)).to({x:96.5},9,cjs.Ease.get(1)).wait(78).to({startPosition:0},0).to({_off:true},1).wait(813));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-31,8.3,333.6,61.8);
...
p.nominalBounds = new cjs.Rectangle(-32,0.7,261.4,21.7);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(416.4,196.1,1,1,0,0,0,42.4,10.1);
	...
	this.instance_2.setTransform(423.5,194.8,1,1,0,0,0,43.5,7.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).wait(111).to({startPosition:111},0).to({x:445.3,alpha:0,startPosition:127},16,cjs.Ease.get(1)).wait(99));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1699544371253", id:"bg1"},
		{src:"images/bg2.jpg?1699544371253", id:"bg2"},
		{src:"images/logomec.png?1699544371253", id:"logomec"},
		{src:"images/logo.png?1699544371253", id:"logo"}
	],
	preloads: []
};
