...
p.nominalBounds = new cjs.Rectangle(0,0,280.8,526.5);
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(119.1,12.3);
...
p.nominalBounds = new cjs.Rectangle(5.3,1.3,227.6,22.099999999999998);
...
(lib.Symbol16copy = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(60.1,16.05);
...
p.nominalBounds = new cjs.Rectangle(2.4,5.9,115.39999999999999,20.4);
...
p.nominalBounds = new cjs.Rectangle(-21.5,-4.6,124,29.200000000000003);
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:63.8,alpha:1},11,cjs.Ease.get(1)).to({x:62.3},9,cjs.Ease.get(1)).wait(105).to({startPosition:0},0).to({_off:true},1).wait(1).to({_off:false},0).wait(98).to({startPosition:0},0).to({_off:true},1).wait(964));
...
p.nominalBounds = new cjs.Rectangle(-29.7,1.3,263.4,49.2);
...
p.nominalBounds = new cjs.Rectangle(-4.1,-6,332.70000000000005,496.8);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(188.35,239.15,1.3,1.3,0,0,0,140.4,263.1);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:263.2,scaleX:1,scaleY:1,x:188.4,y:239.2,alpha:1},17,cjs.Ease.get(1)).wait(94).to({startPosition:0},0).to({_off:true},1).wait(115).to({_off:false},0).wait(4073));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-4.1,-102.9,375,684.4);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(137.6,151.9,1,1,0,0,0,42.4,10.1);
	...
	this.instance_2.setTransform(137.5,151.8,1,1,0,0,0,43.5,7.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).wait(111).to({startPosition:110},0).to({x:166.3,alpha:0,startPosition:127},16,cjs.Ease.get(1)).wait(99));
...
p.nominalBounds = new cjs.Rectangle(155.9,234.1,172.70000000000002,256.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1699543818935", id:"bg1"},
		{src:"images/bg2.jpg?1699543818935", id:"bg2"},
		{src:"images/logomec.png?1699543818935", id:"logomec"},
		{src:"images/logo.png?1699543818935", id:"logo"}
	],
	preloads: []
};
