...
(lib.Symbol12 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FEFEFE").s().p("");
	this.shape.setTransform(42.925,8.425);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(175).to({_off:true},1).wait(4124));
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({y:9,alpha:1},7,cjs.Ease.get(1)).to({y:7.8},7,cjs.Ease.get(1)).wait(175).to({startPosition:0},0).to({_off:true},1).wait(1263).to({_off:false},0).to({_off:true},7).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).to({y:26.25,alpha:1},7,cjs.Ease.get(1)).to({y:25.05},7,cjs.Ease.get(1)).wait(179).to({startPosition:0},0).to({_off:true},1).wait(1263).to({_off:false},0).to({_off:true},3).wait(6));
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(79).to({_off:false},0).wait(147));
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(289.1,122.9,1.21,1.21,0,0,0,103.4,8.2);
	this.instance_4._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(109).to({_off:false},0).to({x:125},14,cjs.Ease.get(1)).wait(103));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(109).to({startPosition:65},0).to({x:-210,startPosition:73},14,cjs.Ease.get(1)).wait(103));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1693645313582", id:"bg1"},
		{src:"images/bg2.jpg?1693645313582", id:"bg2"},
		{src:"images/l1.png?1693645313582", id:"l1"},
		{src:"images/logo.png?1693645313582", id:"logo"}
	],
	preloads: []
};
