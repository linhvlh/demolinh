...
p.nominalBounds = new cjs.Rectangle(0,0,706,500);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("A1FTiMAAAgnDMAqLAAAMAAAAnDg");
	this.shape.setTransform(483.5124,125,0.9889,1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("A02TiMAAAgnDMAptAAAMAAAAnDg");
	this.shape_1.setTransform(483.5,125);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},225).to({state:[]},1).wait(4074));

	// Layer_2
	this.instance = new lib.bg2();
	this.instance.parent = this;
	this.instance.setTransform(617,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(225).to({_off:true},1).wait(4074));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(225).to({_off:true},1).wait(4074));
...
(lib.Symbol18 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("ApvCUIAAkmITfAAIAAEmg");
	mask.setTransform(50.725,11.05);
...
p.nominalBounds = new cjs.Rectangle(-11.6,-3.7,124.69999999999999,29.5);
...
(lib.main = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(489.3,186.4,0.79,0.79,0,0,0,15.6,15.7);
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(485.05,206.5,0.7,0.7,0,0,0,11.5,19.3);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(475.4,156.1,1,1,0,0,0,42.4,10.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(485.55,156.7,1.4799,1.4799,0,0,0,43.6,7.9);
	this.instance_3._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(570.15,73.85,0.96,0.96,0,0,0,103.3,8.2);
	this.instance_4._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(226));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg1.jpg?1694082094813", id:"bg1"},
		{src:"images/bg2.jpg?1694082094813", id:"bg2"},
		{src:"images/l1.png?1694082094813", id:"l1"},
		{src:"images/logo.png?1694082094813", id:"logo"}
	],
	preloads: []
};
